...
public class TinyScreenCapture : MonoBehaviour
{
    ...
    [Header("Prefix for saved filed.")] public string fileName = "screenshoot";
    ...
    private IEnumerator TinyCapture()
    {
        ...
        while (i < endIndex)
        {
            ...
            //sufix for filename
            var timestamp = System.DateTime.Now.ToString("dd_MM_yyyy_HH_mm_ss");

            //save image
            var basePath = Application.dataPath + "/../Assets/TinyScreenCapture/ScreenCapture/";
            var targetFolderPath = basePath + $"{Screen.width}x{Screen.height}/";
